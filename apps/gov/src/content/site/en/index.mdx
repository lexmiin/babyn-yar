...
import { AstroImage, LinkButton } from '@/components/ui'
import babynYarImage from '@/assets/main/img_0.webp'
import menorahImage from '@/assets/main/img_1.webp'
import synagogueImage from '@/assets/main/img_2.webp'

<AstroImage src={babynYarImage} alt="Babyn Yar" priority />
...
<AstroImage src={menorahImage} alt="Mehorah" />
...
<AstroImage src={synagogueImage} alt="TODO" />
