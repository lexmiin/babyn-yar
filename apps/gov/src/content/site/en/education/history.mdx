...
import { AstroImage, Video } from '@/components/ui'
import noticeImage from '@/assets/history/img_0.webp'
import peopleInRavineImage from '@/assets/history/img_1.webp'
import barbedWireImage from '@/assets/history/img_2.webp'
...
<AstroImage
  src={noticeImage}
  alt="Occupation notice in Russian and Ukrainian ordering Kyiv's Jews to assemble on September 29, 1941"
/>
...
<AstroImage
  src={peopleInRavineImage}
  alt="A crowd of people walking through a ravine"
/>
...
<AstroImage
  src={barbedWireImage}
  alt="Barracks behind several rows of barbed-wire fencing"
/>
