...
export const LAYER_FOUR_POI_SCENE = {
  ...
  overview: [
    ...
    "Після падіння комуністичної диктатури та цензури, але без системної участі держави, на території Бабиного Яру та поруч почали безсистемно з'являтися пам'ятники й меморіальні таблиці різних організацій.",
    "На межі перебудови й незалежності, у 1991 році, встановили «Менору» та пам'ятний знак на місці Сирецького табору. У 1992-му прихильники ОУН(м) поставили дерев'яний (пізніше — кам'яний) хрест загиблим членам організації з меморіальними таблицями, а у 2017 році — пам'ятник Олені Телізі біля станції метро «Дорогожичі». У 2001 році відкрили пам'ятник дітям, розстріляним у Бабиному Яру, а неподалік від хреста мельниківцям — стелу на честь так і не збудованого єврейського центру «Спадщина». У 2009-му біля радянського монумента 1976 року з'явився пам'ятник підпільниці Тетяні Маркус, а у 2016-му на території НІМЗ «Бабин Яр» відкрили «Ромську кибитку» — пам'ять про жертв Пораймосу.",
    ...
    "У 2020–2021 роках приватний фонд «Меморіальний центр Голокосту «Бабин Яр»» створив кілька об'єктів на території заповідника.",
    'У вересні 2020-го відкрили інсталяцію «Дзеркальне поле» на місці зруйнованого Єврейського кладовища — сорокаметровий дзеркальний диск і простріляні кулями колони, з яких лунають імена загиблих.',
    "У травні 2021-го з'явилася символічна синагога «Місце для роздумів» архітектора Мануеля Герца — дерев'яна будівля-трансформер, що розгортається як книга.",
    "У жовтні того ж року відкрили «Кришталеву стіну плачу» — артоб'єкт Марини Абрамович.",
    "Також фонд встановив серію інсталяцій «Погляд у минуле» — дерев'яні окуляри-телескопи з архівними фото в різних точках міста.",
    "У березні 2021-го з'явився пам'ятний знак Олега Шовенка на честь жертв Куренівської трагедії.",
    "Загалом з 1991 до 2026 року в Бабиному Яру встановили близько трьох десятків пам'ятників і меморіальних таблиць.",
    'У 2023 році було ревіталізовано будівлю спорткомплексу «Авангард» та відкрито Виставковий центр «Жива пам’ять».',
    'Відтоді тут реалізовано понад 15 виставкових та освітніх проєктів, серед яких «Бабин Яр: Дзеркала смерті», «Невидимі. Стійкість: минуле і сучасність ромів», «Коли руйнується світ», спільна виставка з Меморіальним музеєм Голокосту США «Держава обману: сила нацистської пропаганди», а також «Українсько-єврейське століття: фото та історії від 1920 до 2025» у співпраці з Centropa.',
