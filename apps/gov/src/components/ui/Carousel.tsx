  ...
  function Carousel(props, ref) {
    ...
    return (
      <div className="relative h-full">
        ...
        <button
          onClick={scrollPrev}
          className="absolute top-1/2 left-2 -translate-y-1/2 rounded-full bg-black p-3 text-white hover:opacity-75"
        >
          <ChevronLeft size={16} />
        </button>
        <button
          onClick={scrollNext}
          className="absolute top-1/2 right-2 -translate-y-1/2 rounded-full bg-black p-3 text-white hover:opacity-75"
        >
          <ChevronRight size={16} />
        </button>
        <button
          onClick={onClose}
          className="absolute top-12 right-2 -translate-y-1/2 rounded-full bg-black p-3 text-white hover:opacity-75"
        >
          <XIcon size={16} />
        </button>
      </div>
